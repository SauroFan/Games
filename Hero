...
class Vlad(Hero):
    ...
    def print_info(self):
        print('Vlad had evil force')
        sleep(2)
        print("Vlad needs killed we all", self.health, "and armor is ", self.armor)
        sleep(2)
        print("Vlad needs help")
        sleep(2)
...
class Yarik(Hero):
    ...
    def attack(self, enemy):
        print("Help!!", self.name, "health", enemy.name)
        sleep(2)
        print("Health!")
        sleep(2)
    ...
    def print_info(self):
        print('You`ve had evil power, I`ll heal you')
        sleep(2) 
        print("Vlad attack is", self.demage, "and armor is ", self.armor)
        sleep(2)
        print("I`ll save you!")
        sleep(2)
